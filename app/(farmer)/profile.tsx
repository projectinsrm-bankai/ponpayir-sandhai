            ...
            <ScrollView contentContainerStyle={{ padding: 20 }}>
                ...
                <View className="mb-4 rounded-xl bg-[#FFE5E7] border border-[#FF4B4B] flex-row items-center p-3">
                    ...
                    <View className="flex-1">
                        <Text className="font-quicksand-bold text-[#FF2A2A] mb-1">Please complete Verification</Text>
                        <Text className="font-quicksand text-[#AD1818]">Verify your identity and documents to use all features.</Text>
                    </View>
                ...
                <View className="rounded-xl border border-[#BCD657] bg-[#EAF6BC] p-4 mb-6 items-center">
                    ...
                    <Text className="font-quicksand text-[#67671A] mb-2">Farmer</Text>
